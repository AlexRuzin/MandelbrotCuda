...
namespace render
{
	...
	public:
		sdlBase(size_t height, size_t width, std::string windowTitle, const uint8_t crosshairColorIn[3]) :
			...
			drawCrosshair(false)
		{
			std::memcpy(crosshairColor, crosshairColorIn, 3);
